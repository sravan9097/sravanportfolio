...
const WhatIDo = () => {
  const capabilities = [
    ...
    },
    {
      ...
      description: "I prototype in TypeScript/React (or Stroybook) to validate interactions, states, and edge cases. When it’s right, I ship production-ready components to reduce handoff friction."
    }
  ];
      ...
      <div className="container-padded">
        <div className="flex flex-col md:flex-row justify-between gap-12 item-end">
          <div className="mb-12">
            ...
            <p className="text-xl md:text-2xl text-foreground font-medium leading-snug max-w-4xl mt-4 pl-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
            ...
            <div className="md:col-span-1 p-8 rounded-2xl bg-gradient-to-br from-blue-50/50 to-blue-100/30 dark:from-blue-950/20 dark:to-blue-900/10 hover:shadow-lg dark:hover:shadow-blue-500/20 dark:hover:shadow-2xl transition-all border border-border/50 hover:border-blue-200 dark:hover:border-blue-800 group">
            ...
            {/* Card 2 - UX design */}
            <div className="md:col-span-1 p-8 h-full rounded-2xl bg-gradient-to-br from-green-50/50 to-green-100/30 dark:from-green-950/20 dark:to-green-900/10 hover:shadow-lg dark:hover:shadow-green-500/20 dark:hover:shadow-2xl transition-all border border-border/50 hover:border-green-200 dark:hover:border-green-800 group">
              <div className="flex items-start gap-4 mb-4">
            ...
            <div className="md:col-span-2 p-8 rounded-2xl bg-gradient-to-br from-purple-50/50 to-purple-100/30 dark:from-purple-950/20 dark:to-purple-900/10 hover:shadow-lg dark:hover:shadow-purple-500/20 dark:hover:shadow-2xl transition-all border border-border/50 hover:border-purple-200 dark:hover:border-purple-800 group">
