        ...
        <Tabs defaultValue="buttons" className="w-full">
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-card-foreground">With Error</label>
                    <input
                      type="text"
                      placeholder="Enter text..."
                      className="w-full px-3 py-2 border border-red-500 rounded-md bg-background text-foreground"
                    />
                  </div>
                </div>
              </CardContent>
          ...
          <TabsContent value="cards" className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <Card>
                <CardContent className="pt-6">
                  <h3 className="text-lg font-medium mb-2 text-card-foreground">Card with Action</h3>
                  <p className="text-muted-foreground mb-4">This card includes an action button.</p>
