...
import { Mail, Phone, MapPin, Linkedin, Twitter, Dribbble, Instagram, Figma, Sparkles } from "lucide-react";
            ...
            <div className="md:col-span-2 md:order-1 order-2 space-y-6">
              ...
              <div className="pt-6">
                ...
                <div className="flex gap-4 flex-wrap">
                  ...
                  <a href="https://www.dribbble.com/sravankumar" target="_blank" rel="noopener noreferrer" className="bg-accent/10 p-3 rounded-full hover:bg-accent/20 transition-colors">
                    <Dribbble className="w-5 h-5 text-accent" />
                  </a>
                  <a href="https://lottiefiles.com/sravan" target="_blank" rel="noopener noreferrer" className="bg-accent/10 p-3 rounded-full hover:bg-accent/20 transition-colors">
